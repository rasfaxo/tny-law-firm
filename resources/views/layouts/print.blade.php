...
<body data-auto-print class="bg-slate-100 font-sans text-slate-800 antialiased min-h-screen">
    ...
    <header class="no-print sticky top-0 z-50 bg-[#0F1E3A] text-white border-b border-slate-700 shadow-md">
        <div class="max-w-5xl mx-auto px-6 py-3 flex items-center justify-between">
            ...
            <div class="flex items-center gap-3">
                <button type="button" data-window-close class="px-4 py-2 text-xs font-semibold rounded-lg bg-slate-800 hover:bg-slate-700 text-slate-200 transition cursor-pointer">
                    ← Tutup Tab
                </button>
                <button type="button" data-window-print class="px-5 py-2 text-xs font-bold rounded-lg bg-blue-600 hover:bg-blue-500 text-white flex items-center gap-2 shadow-sm transition cursor-pointer">
