...
<div {{ $attributes->merge(['class' => 'text-center py-12 px-4 border-2 border-dashed border-[#E2E8F0] rounded-[20px] bg-[#F8FAFC] flex flex-col items-center justify-center']) }}>
