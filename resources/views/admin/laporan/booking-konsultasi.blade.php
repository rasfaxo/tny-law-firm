    ...
    <div class="space-y-5">
        ...
        <div class="bg-white border border-[#e2e8f0] rounded-[16px] p-5 shadow-sm space-y-3 no-print">
            ...
            <div class="flex flex-wrap gap-2.5">
                ...
                <a href="{{ route('admin.laporan.booking-konsultasi') }}" class="inline-flex items-center gap-2 bg-[#1e3a8a] text-white border border-[#1e3a8a] text-[13px] font-semibold px-4 py-2 rounded-[12px] transition shadow-xs">
        ...
        <div class="bg-white border border-[#e2e8f0] rounded-[16px] p-6 shadow-sm no-print">
            <form method="GET" action="{{ route('admin.laporan.booking-konsultasi') }}" class="space-y-5">
                <div class="grid grid-cols-1 gap-4 sm:grid-cols-2 lg:grid-cols-5">
                    ...
                    <div>
                        <label for="status_booking" class="block text-[10px] font-semibold text-[#64748b] tracking-[0.25px] uppercase mb-2">Status Booking</label>
                    ...
                    <div>
                        <label for="metode_konsultasi" class="block text-[10px] font-semibold text-[#64748b] tracking-[0.25px] uppercase mb-2">Metode Konsultasi</label>
                    ...
                    <div>
                        <label for="status_konfirmasi_konsultasi" class="block text-[10px] font-semibold text-[#64748b] tracking-[0.25px] uppercase mb-2">Status Konfirmasi</label>
                        <select id="status_konfirmasi_konsultasi" name="status_konfirmasi_konsultasi" 
                            class="w-full bg-[#f8fafc] border border-[#e2e8f0] focus:border-[#1e3a8a] focus:ring focus:ring-[#1e3a8a]/20 rounded-[12px] text-[13px] transition shadow-sm h-11 px-4 text-[#0f172a]">
                            <option value="">Semua Status</option>
                ...
                <div class="flex flex-wrap items-center gap-3 pt-4 border-t border-[#e2e8f0]">
                    ...
                    <a href="{{ route('admin.laporan.booking-konsultasi') }}" class="bg-white border border-[#e2e8f0] hover:bg-gray-50 text-[#334155] rounded-[12px] h-11 px-5 text-[13px] font-semibold transition shadow-sm inline-flex items-center gap-2">
                    ...
                    <a href="{{ route('admin.laporan.booking-konsultasi.cetak', request()->query()) }}" target="_blank" class="bg-emerald-600 hover:bg-emerald-700 text-white rounded-[12px] h-11 px-5 text-[13px] font-semibold transition shadow-sm inline-flex items-center gap-2 ml-auto">
                        <svg class="h-4 w-4 shrink-0" fill="none" stroke="currentColor" viewBox="0 0 24 24">
        ...
        <div class="bg-white border border-[#e2e8f0] rounded-[16px] shadow-sm overflow-hidden print-area">
            <div class="p-6 border-b border-[#f1f5f9] flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
                <div>
                    <h3 class="font-bold text-[#0f172a] text-[16px]">{{ __('Laporan Booking Konsultasi') }}</h3>
                ...
                <table class="min-w-full divide-y divide-[#e2e8f0]">
                    <thead class="bg-[#f8fafc]">
                        <tr>
                            ...
                            <th class="px-4 py-3.5 text-left text-[10px] font-semibold text-[#64748b] uppercase tracking-[0.25px]">Kategori</th>
                            <th class="px-4 py-3.5 text-left text-[10px] font-semibold text-[#64748b] uppercase tracking-[0.25px]">Tanggal Jadwal</th>
                            <th class="px-4 py-3.5 text-left text-[10px] font-semibold text-[#64748b] uppercase tracking-[0.25px]">Waktu</th>
                            <th class="px-4 py-3.5 text-left text-[10px] font-semibold text-[#64748b] uppercase tracking-[0.25px]">Metode</th>
                            <th class="px-4 py-3.5 text-left text-[10px] font-semibold text-[#64748b] uppercase tracking-[0.25px]">Konfirmasi</th>
                            <th class="px-4 py-3.5 text-left text-[10px] font-semibold text-[#64748b] uppercase tracking-[0.25px]">Status Booking</th>
                            <th class="px-4 py-3.5 text-left text-[10px] font-semibold text-[#64748b] uppercase tracking-[0.25px]">Tanggal Booking</th>
                        </tr>
                    </thead>
