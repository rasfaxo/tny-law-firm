...
class LaporanController extends Controller
{
    ...
    public function praPendaftaran(ReportFilterRequest $request): View
    {
        $filters = $request->validate([
            'tanggal_mulai' => ['nullable', 'date'],
            'tanggal_selesai' => [
    ...
    public function verifikasiBerkas(ReportFilterRequest $request): View
    {
        $filters = $request->validate([
            'tanggal_mulai' => ['nullable', 'date'],
            'tanggal_selesai' => [
    ...
    public function bookingKonsultasi(ReportFilterRequest $request): View
    {
        $filters = $request->validate([
            'tanggal_mulai' => ['nullable', 'date'],
            'tanggal_selesai' => [
    ...
    public function rescheduleKonsultasi(ReportFilterRequest $request): View
    {
        $filters = $request->validate([
            'tanggal_mulai' => ['nullable', 'date'],
            'tanggal_selesai' => [
    ...
    public function pengajuanSelesai(ReportFilterRequest $request): View
    {
        $filters = $request->validate([
            'tanggal_mulai' => ['nullable', 'date'],
            'tanggal_selesai' => [
    ...
    public function cetakIndex(ReportFilterRequest $request): View
    {
        $filters = $request->validate([
            'tanggal_mulai' => ['nullable', 'date'],
            'tanggal_selesai' => [
    ...
    public function cetakPraPendaftaran(ReportFilterRequest $request): View
    {
        $filters = $request->validate([
            'tanggal_mulai' => ['nullable', 'date'],
            'tanggal_selesai' => [
    ...
    public function cetakVerifikasiBerkas(ReportFilterRequest $request): View
    {
        $filters = $request->validate([
            'tanggal_mulai' => ['nullable', 'date'],
            'tanggal_selesai' => [
    ...
    public function cetakBookingKonsultasi(ReportFilterRequest $request): View
    {
        $filters = $request->validate([
            'tanggal_mulai' => ['nullable', 'date'],
            'tanggal_selesai' => [
    ...
    public function cetakRescheduleKonsultasi(ReportFilterRequest $request): View
    {
        $filters = $request->validate([
            'tanggal_mulai' => ['nullable', 'date'],
            'tanggal_selesai' => [
    ...
    public function cetakPengajuanSelesai(ReportFilterRequest $request): View
    {
        $filters = $request->validate([
            'tanggal_mulai' => ['nullable', 'date'],
            'tanggal_selesai' => [
