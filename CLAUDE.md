...
This file is only an adapter for Claude. Do not treat this file as a replacement for `AGENTS.md`.

Claude must read `AGENTS.md` first before following this adapter file.
...
Claude must not override the locked thesis design.
