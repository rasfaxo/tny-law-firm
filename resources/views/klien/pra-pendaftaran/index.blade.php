        ...
        <div class="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
            <div>
                ...
                <div class="flex items-center gap-1 text-xxs font-semibold text-gray-400 uppercase tracking-wider mb-1">
                    ...
                    <span class="text-gray-600">Daftar Pengajuan</span>
                </div>
                <h2 class="font-extrabold text-2xl text-navy-dark leading-tight">
                    {{ __('Daftar Pengajuan Perkara') }}
                </h2>
            </div>
        ...
        <div class="bg-white border border-[#E2E8F0] p-6 rounded-2xl shadow-sm">
            <form method="GET" action="{{ route('klien.pra-pendaftaran.index') }}" class="grid grid-cols-1 md:grid-cols-12 gap-4 items-end">
                ...
                <div class="md:col-span-6 space-y-1.5">
                    <label for="search" class="block text-xxs font-bold text-gray-400 uppercase tracking-wider">Cari Pengajuan</label>
                    <div class="relative">
                ...
                <div class="md:col-span-4 space-y-1.5">
                    <label for="status" class="block text-xxs font-bold text-gray-400 uppercase tracking-wider">Filter Status</label>
                ...
                <table class="min-w-full divide-y divide-[#F1F5F9]">
                    <thead class="bg-[#F8FAFC]">
                        <tr>
                            ...
                            <th class="px-6 py-4 text-left text-xxs font-bold text-gray-400 uppercase tracking-wider">Tanggal Pengajuan</th>
